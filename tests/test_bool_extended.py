...
def test_bool_deserialization_true_false() -> None:
    ...
    for test_value, expected_result in zip(test_cases, expected):
        ...
        assert result == BoolWrapper(value=expected_result), f"Failed for {test_value}"
